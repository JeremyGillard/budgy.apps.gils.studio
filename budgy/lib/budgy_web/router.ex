defmodule BudgyWeb.Router do
  ...
  scope "/", BudgyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BudgyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BudgyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BudgyWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BudgyWeb do
    ...
    live_session :current_user,
      on_mount: [{BudgyWeb.UserAuth, :mount_current_user}] do
